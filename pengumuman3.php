            ...
            <div class="d-lg-flex flex-row justify-content-start">
                <div class="d-flex flex-column justify-content-start content">
                    <div class="d-flex flex-row justify-content-start">
                        <h4>Tata Tertib Wawancara<br>Seleksi Mutasi Internal Pegawai Negeri Sipil<br>Lingkungan Kementrian Kesehatan<br>Tahun 2021</h4>
                    </div>
                    <div class="d-flex flex-row justify-content-start">
                    ...
                    <div class="d-flex flex-row justify-content-start main-content">
                        <p>Sehubungan dengan diadakannya Seleksi Mutasi Internal Pegawai Negeri Sipil di Lingkungan Kementrian Kesehatan 2021, 
                            maka adapun tata tertib yang harus dijalankan oleh para pelamar yang lulus tahapan seleksi sebelumnya untuk melakukan tahapan wawancara. 
                            Diharapkan kepada para pelamar untuk memcermati dengan seksama tata tertib dari Wawancara Seleksi Mutasi Internal Pegawai Negeri Sipil 
                            di Lingkungan Kesehatan Tahun 2021 pada pengumuman yang terlampir.</p>
                    </div>
                </div>
                    <div class="d-flex flex-column justify-content-center" style="margin-left: 16%;">
                        <iframe src="img/content3.pdf" frameborder="0" height="80%"></iframe>
                    </div>
            </div>
        </div>
