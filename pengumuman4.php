            ...
            <div class="d-lg-flex flex-row justify-content-start">
                <div class="d-flex flex-column justify-content-start content">
                    <div class="d-flex flex-row justify-content-start">
                        <h4>Surat Edaran Pelaksanaan<br>Kenaikan Jabatan Periode Kenaikan Pangkat<br>April 2021</h4>
                    </div>
                    <div class="d-flex flex-row justify-content-start">
                    ...
                    <div class="d-flex flex-row justify-content-start main-content">
                        <p>Sehubungan dengan adanya Pelaksanaan Kenaikan Jabatan Fungsional Periode Kenaikan Pangkat April 2021, 
                            maka berikut merupakan surat edaran dari Kementrian Kesehatan Republik Indonesia. Surat edaran ini 
                            berisikan persyaratan untuk melakukan pengusulan proses kenaikan pangkat/jabatan fungsional periode 
                            kenaikan pangkat April 2021. Diharapkan bagi seluruh pegawai Rumah Sakit Teknologi Informasi untuk 
                            mencermati dengan baik surat edaran mengenai kenaikan jabatan ini.</p>
                    </div>
                </div>
                    <div class="d-flex flex-column justify-content-center" style="margin-left: 16%;">
                        <iframe src="img/content4.pdf" frameborder="0" height="80%"></iframe>
                    </div>
            </div>
        </div>
