            ...
            <div class="d-flex flex-column justify-content-evenly" style="margin-top: 3vh; margin-left: 3vw; margin-right: 3vw; margin-bottom: 5vh;">
                ...
                <table class="table table-bordered" style="margin-top: 2vh;">
                    <tbody>
                        <tr>
                        <th colspan="6">
                            <a href="./jadwal_input_a.php" style="text-decoration:none; color: blue">Tambah jadwal</a>
                        </th>
                        </tr>
                        <tr>
                        <th>Id</th>
                        ...
                        <?php while ($user = $statement->fetch(PDO::FETCH_ASSOC)) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="./jadwal_edit_a.php?id_jadwal=<?= $user['id_jadwal'] ?>" style="text-decoration:none; color: blue">Edit</a>
                                    |
                                    <a href="./jadwal_hapus_a.php?id_jadwal=<?= $user['id_jadwal'] ?>" style="text-decoration:none; color: red">Hapus</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
