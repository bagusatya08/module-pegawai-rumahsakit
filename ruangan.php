            ...
            <div class="d-flex flex-column justify-content-evenly" style="margin-top: 3vh; margin-left: 3vw; margin-right: 3vw; margin-bottom: 5vh;">
                ...
                <table class="table table-bordered" style="margin-top: 2vh;">
                    <tbody>
                        <tr>
                        <th colspan="3">
                            <a href="./ruangan_input.php" style="text-decoration:none; color: blue">Tambah Ruangan</a>
                        </th>
                        </tr>
                        <tr>
                        <th>Id</th>
                        ...
                        <?php while ($user = $statement->fetch(PDO::FETCH_ASSOC)) : ?>
                            <tr>
                                <td>
                                    <?php echo $user['id_ruangan'] ?>
                                </td>
                                <td>
                                    <?php echo $user['nama_ruangan'] ?>
                                </td>
                                <td>
                                    <a href="./ruangan_edit.php?id_ruangan=<?= $user['id_ruangan'] ?>" style="text-decoration:none; color: blue">Edit</a>
                                    |
                                    <a href="./ruangan_hapus.php?id_ruangan=<?= $user['id_ruangan'] ?>" style="text-decoration:none; color: red">Hapus</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
