            ...
            <div class="d-flex flex-column justify-content-evenly" style="margin-top: 3vh; margin-left: 3vw; margin-right: 3vw; margin-bottom: 5vh;">
                ...
                <table class="table table-bordered" style="margin-top: 2vh;">
                    <tbody>
                        <tr>
                        <th colspan="7">
                            <a href="./panduan_input.php" style="text-decoration:none; color: blue">Buat panduan</a>
                        </th>
                        </tr>
                        <tr>
                        <th>Id</th>
                        ...
                        <?php while ($user = $statement->fetch(PDO::FETCH_ASSOC)) : ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo $user['status_panduan'] ?>
                                </td>
                                <td>
                                    <a href="./panduan_edit.php?id_panduan=<?= $user['id_panduan'] ?>" style="text-decoration:none; color: blue">Edit</a>
                                    |
                                    <a href="./panduan_hapus.php?id_panduan=<?= $user['id_panduan'] ?>" style="text-decoration:none; color: red">Hapus</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
